...
namespace WebApplicationMovies.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProducerID,FirstName,LastName,ImageURL,DayOfBirth")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProducerID,FirstName,LastName,ImageURL,DayOfBirth")] Producer producer)
        {
